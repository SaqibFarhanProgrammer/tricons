...
function CTASection() {
  return (
    <section className="relative w-full bg-white py-24 md:py-32 lg:py-40 px-6 md:px-10 overflow-hidden">

      <div className="relative z-10 max-w-4xl mx-auto text-center">

        {/* Label */}
        <span className="text-black/40 text-[10px] tracking-[0.2em] uppercase block mb-6">
        ...
        <p className="text-black/50 text-base md:text-lg leading-relaxed max-w-xl mx-auto mt-6 md:mt-8">
          We help brands design, build, and scale digital products that actually perform.
        </p>
