  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto">
        <h2
          id="about-heading"
          className="text-black text-3xl sm:text-4xl md:text-5xl lg:text-6xl leading-[1.15] tracking-tight font-semibold"
        >
        ...
        <p className="text-black/60 text-lg md:text-xl lg:text-2xl leading-relaxed mt-10 md:mt-14 max-w-3xl">
          From building strong brand identities to developing high-performance
          websites and running conversion-driven ad campaigns, we handle the full
          digital ecosystem.
        </p>

        <p className="text-black/50 text-base md:text-lg leading-relaxed mt-6 md:mt-8 max-w-2xl">
          Every project is tailored. No templates, no shortcuts — only strategies
          designed around your business goals and audience behavior.
        </p>
